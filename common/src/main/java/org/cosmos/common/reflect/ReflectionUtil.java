package org.cosmos.common.reflect;
...
import org.cosmos.common.base.ExceptionUtil;
import org.cosmos.common.base.type.UncheckedException;
    ...
    public static <T> T invokeMethod(final Object obj, final String methodName, final Object[] args,
        ...
        if (method == null) {
            throw new IllegalArgumentException("Could not find method [" + methodName + "] with parameter types:"
                    + ReflectionToStringBuilder.toString(parameterTypes) + " on class [" + obj.getClass() + ']');
        }
