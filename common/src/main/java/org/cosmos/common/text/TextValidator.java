...
public class TextValidator {
    ...
    private static final String REGEX_DATE =
        "^(?:(?!0000)[0-9]{4}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-8])|(?:0[13-9]|1[0-2])-(?:29|30)|"
            + "(?:0[13578]|1[02])-31)|(?:[0-9]{2}(?:0[48]|[2468][048]|[13579][26])|(?:0[48]|[2468][048]|[13579][26])00)"
					+ "-02-29)$";
    ...
    private static final Pattern PATTERN_REGEX_ZH = Pattern.compile(REGEX_ZH);
    ...
    public static boolean isZh(@Nullable CharSequence input){
        return isMatch(PATTERN_REGEX_ZH,input);
    }
