...
<div id="wrapper">
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        <li><a href="${springMacroRequestContext.contextPath}/user" target="iFrame">Dashboard v
                            .1</a></li>
    ...
    <div id="page-wrapper" class="gray-bg" style="padding-left: 0;padding-right: 0;">
        ...
        <iframe name="iFrame" frameborder="0" width="100%" scrolling="no"
                src="${rc.contextPath}/user" data-id="${rc.contextPath}/user" id="iFrame" onload="changeFrameHeight()">
        </iframe>
...
<!-- Mainly scripts -->
<script src="${rc.contextPath}/js/jquery-3.1.1.min.js"></script>
...
<script src="${rc.contextPath}/js/inspinia.js"></script>
