...
<head>
    ...
    <link href="${rc.contextPath}/css/plugins/dataTables/datatables.min.css" rel="stylesheet">
...
<script src="${rc.contextPath}/js/plugins/dataTables/datatables.min.js"></script>
<!-- Page-Level Scripts -->
<script>
